...
class StopAndWaitARQ(wimemac.wimemac.Component):
    def __init__(self, _node, _name, _phyDataTransmission, _phyNotification, _bufferSize = 20, _sarFragmentSize = 160):
        ...
        arq = wns.FUN.Node("arq", wns.ARQ.StopAndWait(resendTimeout = 0.00001))
...
class SARStopAndWaitARQ(wimemac.wimemac.Component):
    def __init__(self, _node, _name, _phyDataTransmission, _phyNotification, _bufferSize = 20, _sarFragmentSize = 160):
